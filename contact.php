...
<html lang="en">
  ...
  <body>
        ...
        <div class="row">
          <div class="col-md-8 col-xs-12">
            <ul class="left-info">
              ...
              <li><a href="#"><i class="fa fa-phone"></i>9856000001</a></li>
            </ul>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="contact-item">
              ...
              <h4>Phone</h4>
              <p>You can call us for to ask more information realted to our driving institute</p>
              <a href="#">9800000000</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="contact-item">
              ...
              <h4>Email</h4>
              <p>You can send Email to get know and related information about our institute.</p>
              <a href="#">sundar@company.com</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="contact-item">
              ...
              <h4>Location</h4>
              <p>Fulbari pokhara-11<br>Bhanu-MArg, 33700</p>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <span>hello customer you csn send us a message,you can get instant message from our realtime available staff.</span>
            </div>
          </div>
          <div class="col-md-12">
   ...
   <div class="callback-form mb-5 mb-5" >
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="section-heading">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            ...
            <span>Learn more about Sundar Driving Institute</span>
          </div>
          <div class="col-md-4">
            <a href="#" class="border-button"> See Services </a>
          </div>
        </div>
      </div>
    </div>
